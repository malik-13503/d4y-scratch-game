...
export function SignupSuccessPopup({ 
  ...
  return (
    <AlertDialog open={isOpen} onOpenChange={onClose}>
      <AlertDialogContent className="max-w-md mx-auto bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 border-2 border-purple-500/50 shadow-2xl backdrop-blur-sm">
        ...
        <div className="relative z-10">
          <AlertDialogHeader className="text-center space-y-4">
            ...
            <AlertDialogTitle className="text-2xl sm:text-3xl font-bold bg-gradient-to-r from-green-400 via-emerald-400 to-teal-400 bg-clip-text text-transparent">
              Welcome to Hit The Road Jackpot!
            </AlertDialogTitle>
            
            <AlertDialogDescription className="text-gray-300 text-base sm:text-lg leading-relaxed">
          ...
          <div className="flex flex-col space-y-3 mt-6">
            <Button 
              onClick={onLoginNow}
              className="w-full bg-gradient-to-r from-green-500 via-emerald-500 to-teal-500 hover:from-green-600 hover:via-emerald-600 hover:to-teal-600 text-white font-bold py-4 text-lg shadow-xl ring-2 ring-green-400/30 hover:ring-green-400/50 transition-all duration-300 transform hover:scale-105"
            >
            ...
            <Button 
              onClick={onClose}
              variant="outline"
              className="w-full border-2 border-gray-400/40 text-gray-300 hover:bg-gray-400/20 hover:text-white font-semibold py-3 text-base shadow-lg transition-all duration-300 hover:border-gray-300/60"
            >
              Maybe Later
            </Button>
          </div>
          ...
          <div className="flex justify-center mt-4 space-x-2 opacity-60">
