        ...
        <div className="relative z-10">
            ...
            <AlertDialogDescription className="text-gray-300 text-sm sm:text-base lg:text-lg leading-relaxed px-2">
              <div className="space-y-2 sm:space-y-3">
                ...
                <p className="text-sm sm:text-base">
                  ...
                  our exclusive gaming community.
                </p>
                <div className="bg-gradient-to-r from-purple-600/30 to-blue-600/30 rounded-lg p-3 sm:p-4 border border-purple-400/30">
                  <p className="text-xs sm:text-sm text-purple-200">
                    ✨ <strong>What's Next:</strong> Log in to access exciting
                    games, win amazing prizes, and start your jackpot journey!
                  </p>
                </div>
              </div>
            </AlertDialogDescription>
          ...
          <div className="flex flex-col space-y-2 sm:space-y-3 mt-4 sm:mt-6 px-2">
            ...
            <Button
              onClick={onClose}
              variant="outline"
              className="w-full border-2 border-gray-400/40 text-black-300 hover:bg-gray-400/20 hover:text-white font-semibold py-2 sm:py-3 text-sm sm:text-base shadow-lg transition-all duration-300 hover:border-gray-300/60"
            >
              Maybe Later
            </Button>
          </div>
