                    ...
                    return (
                      ...
                      >
                        ...
                        <div
                          ...
                          style={{
                            transform: `translate(-50%, -50%) translate(${Math.cos(((angle + 360 / segmentColors.length / 2 - 90) * Math.PI) / 180) * 180}px, ${Math.sin(((angle + 360 / segmentColors.length / 2 - 90) * Math.PI) / 180) * 180}px)`,
                          }}
                        >
                          {wheelNumbers[index]}
                        </div>
