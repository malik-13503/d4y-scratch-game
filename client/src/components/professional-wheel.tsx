                          ...
                          {isClaimed && (
                            <div
                              ...
                              style={{
                                ...
                                left: "50%",
                                top: "50%",
                                transform: `translate(-50%, -50%) translate(${Math.cos(((angle + 360 / segmentCount / 3- 90) * Math.PI) / 180) * (numberRadius * 1)}px, ${Math.sin(((angle + 360 / segmentCount / 3 - 90) * Math.PI) / 180) * (numberRadius * 0.62)}px) rotate(${-rotation}deg)`,
                                transition: isSpinning
                                  ? `transform 8.0s cubic-bezier(0.25, 0.1, 0.25, 1.0)`
                                  : "none",
