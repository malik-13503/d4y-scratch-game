  ...
  (
    {
      ...
      totalNumbers = 200,
      onInitiateSpin,
      availableNumbers: propAvailableNumbers = [],
    },
    ref,
  ) => {
    ...
    const [availableNumbers, setAvailableNumbers] =
      useState<number[]>(propAvailableNumbers);
    ...
    const handleSpin = async () => {
      ...
      setTimeout(async () => {
        ...
        const targetSegmentIndex = frozenWheelNumbers.findIndex(
          (num) => num === spinResult,
        );
        const validTargetIndex =
          targetSegmentIndex !== -1 ? targetSegmentIndex : 0;
        ...
        console.log(
          `🎯 Landing on segment ${validTargetIndex} (number ${spinResult}) at angle ${targetAngle}°`,
        );
                            ...
                            <div
                              ...
                              style={{
                                ...
                                transition: isSpinning
                                  ...
                                  : "none",
                                width:
                                  wheelNumbers.length > 150
                                    ? "18px"
                                    : wheelNumbers.length > 100
                                      ? "22px"
                                      : wheelNumbers.length > 50
                                        ? "28px"
                                        : "36px",
                                height:
                                  wheelNumbers.length > 150
                                ...
                                textShadow:
                                  "0 0 10px rgba(0,0,0,1), 2px 2px 6px rgba(0,0,0,0.9), -2px -2px 4px rgba(0,0,0,0.8)",
                                backgroundColor: "rgba(0,0,0,0.8)",
                                borderRadius: "50%",
                                border: "2px solid rgba(255,255,255,0.95)",
                                boxShadow:
                                  "0 0 15px rgba(255,255,255,0.4), inset 0 0 10px rgba(255,255,255,0.25)",
                                zIndex: 20,
                                fontWeight: "900",
                                letterSpacing: "-0.3px",
                                lineHeight: "1",
