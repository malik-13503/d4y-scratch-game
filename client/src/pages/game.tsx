...
export default function GamePage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 relative overflow-hidden">
      ...
      {/* Main Game Area */}
      <main className="relative z-10 max-w-7xl mx-auto px-2 xs:px-4 sm:px-6 py-3 xs:py-4 sm:py-8">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-3 xs:gap-4 sm:gap-8">
          ...
          <div className="lg:col-span-2 space-y-3 xs:space-y-4 sm:space-y-8">
            ...
            <Card className="bg-black/20 backdrop-blur-xl border border-purple-500/30 shadow-2xl overflow-hidden">
              <CardHeader className="text-center pb-2 sm:pb-4 p-2 xs:p-3 sm:p-6">
              ...
              <CardContent className="p-1 xs:p-2 sm:p-4 lg:p-8">
                <div className="text-center">
                  <ProfessionalWheel 
                    onSpin={handleSpin} 
                    disabled={false}
